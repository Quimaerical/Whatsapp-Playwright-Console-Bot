...
class LoginPage(BasePage):
    ...
    def wait_for_login(self, timeout: int = QR_SCAN_TIMEOUT) -> bool:
        ...
        try:
            ...
            print("[LoginPage] ¡Inicio de sesión detectado exitosamente!")
            # Breve pausa para asegurar sincronización inicial de IndexedDB y cookies
            self.wait_for_timeout(3000)
            return True
        except PlaywrightTimeoutError:
            print("[LoginPage] Tiempo de espera agotado para el escaneo del código QR.")
            return False
